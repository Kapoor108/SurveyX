          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">India, 411014</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <div className="space-y-3">
                ...
                <div className="text-sm">
                  <p className="font-medium text-gray-800">Do you offer training?</p>
                  <p className="text-gray-600">Yes, we provide onboarding and training for all plans.</p>
                </div>
              </div>
            </div>
          </div>
